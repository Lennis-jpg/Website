...
const options = {Abstract:	"Actual instances",
    ...
    Cornucopia:	'A fruit and vegetable filled, horn-shaped container.',
    Unabashed:	'Unembarrassed about openly sharing strong feelings or opinions.',
    Amalgamate:	'To unite two or more things into one.',
    Impermeable: 'Preventing especially liquids to pass or diffuse through.',
    Monepic:	'Composed of a single word or of sentences consisting of a single word.',
    ...
    Observe:	'Examine, Study, Scrutinise',
    Lethal:	'Deadly',
    Agility:	'Quickness',
    Beg:	'Implore',
